<div class="col-md-4 col-xl-3">
  <div class="sidebar px-4 py-md-0">
    ...
    <a class="media text-default align-items-center mb-5" href="blog-single.html">
      <img class="rounded w-65px mr-4" src="/theme/assets/img/thumb/4.jpg">
      <p class="media-body small-2 lh-4 mb-0">Thank to Maryam for joining our team</p>
    </a>

    <a class="media text-default align-items-center mb-5" href="blog-single.html">
      <img class="rounded w-65px mr-4" src="/theme/assets/img/thumb/3.jpg">
      <p class="media-body small-2 lh-4 mb-0">Best practices for minimalist design</p>
    </a>

    <a class="media text-default align-items-center mb-5" href="blog-single.html">
      <img class="rounded w-65px mr-4" src="/theme/assets/img/thumb/5.jpg">
      <p class="media-body small-2 lh-4 mb-0">New published books for product designers</p>
    </a>

    <a class="media text-default align-items-center mb-5" href="blog-single.html">
      <img class="rounded w-65px mr-4" src="/theme/assets/img/thumb/2.jpg">
    ...
    <p class="small-3">TheCmS is a responsive, professional, and multipurpose CMS, powered by Bootstrap 4. TheCmS is a
      powerful and super flexible tool for any
      kind of blogging.</p>
  </div>
</div>